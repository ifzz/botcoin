...
class TestBacktestResults(unittest.TestCase):
    ...
    def test_backtest_2(self):
        ...
        self.assertEqual(p1['sharpe'], -0.74219880452314702)
        ...
        self.assertEqual(p2['total_return'], -82.619999999999962)
        self.assertEqual(p2['ann_return'], -16.562203814489564)
        self.assertEqual(p2['sharpe'], -0.99062060442123534)
        self.assertEqual(p2['trades'], 309)
        self.assertEqual(p2['pct_trades_profit'], 0.6084142394822006)
        self.assertTrue(p2['dangerous'])
        self.assertEqual(p2['dd_max'], 86.142869423192593)
    ...
    def test_backtest_4(self):
        ...
        self.assertEqual(p['total_return'], -10.67669999999994)
        self.assertEqual(p['ann_return'], -5.3936163205393886)
        self.assertEqual(p['sharpe'], -0.39370223309104035)
        self.assertEqual(p['trades'], 146)
        self.assertEqual(p['pct_trades_profit'], 0.3356164383561644)
        self.assertTrue(p['dangerous'])
        self.assertEqual(p['dd_max'], 20.876631733774534)
